...
public class AssistantEmpAdd extends javax.swing.JFrame {

    
    public AssistantEmpAdd() {
        initComponents();
    }
...
if (txtEmployeeId.getText().isEmpty() ||  txtEmployeeName.getText().isEmpty() || txtDOB.getText().isEmpty() ||txtAddress.getText().isEmpty()|| txtIDNo.getText().isEmpty() 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AssistantEmpAdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AssistantEmpAdd().setVisible(true);
            }
        });
    }
