...
public class AssistantSalary extends javax.swing.JFrame {

    public AssistantSalary() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AssistantSalary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AssistantSalary().setVisible(true);
            }
        });
    }
