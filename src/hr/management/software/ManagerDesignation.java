 ...
 * @author User
 */
public class ManagerDesignation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtdp.setFont(new java.awt.Font("Dubai", 1, 18)); // NOI18N

        jLabel5.setFont(new java.awt.Font("Dubai", 1, 18)); // NOI18N
        jLabel5.setText("Designation Name");

        txtdesig.setFont(new java.awt.Font("Dubai", 1, 18)); // NOI18N
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IconPackage/designation mini icon.png"))); // NOI18N
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(txtdesig, javax.swing.GroupLayout.DEFAULT_SIZE, 354, Short.MAX_VALUE)
                                            .addComponent(txtdp))))))
...
try {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if (txtdesig.getText().isEmpty() ||  txtdp.getText().isEmpty())
        {
            JOptionPane.showMessageDialog(null,"Application Cannot be Empty!!!", "Designation Menu",
                    JOptionPane.WARNING_MESSAGE);
        }
        else
        {
                String dpName= txtdp.getText();
                String desigName= txtdesig.getText();
                
                
                Designations newdesignation= new Designations(dpName,desigName);
                
                if(newdesignation.Adddesig())
                {
                JOptionPane.showMessageDialog(null,"Designation Added successfully", "Designation Menu", JOptionPane.INFORMATION_MESSAGE);
                
                }else {
                    JOptionPane.showMessageDialog(null,"Designation adding Failed!!" ,
                            "Designation Menu", JOptionPane.WARNING_MESSAGE);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagerDesignation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManagerDesignation().setVisible(true);
            }
        });
    }
