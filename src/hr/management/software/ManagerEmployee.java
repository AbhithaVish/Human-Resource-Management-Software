...
public class ManagerEmployee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnAddAssistant.setFont(new java.awt.Font("Dubai", 1, 14)); // NOI18N
        btnAddAssistant.setText("Add Assistant");
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IconPackage/add assistant icon.png"))); // NOI18N
    ...
    private void btnAddEmployeeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddEmployeeActionPerformed
        ManagerEmpAdd DisplayPage = new ManagerEmpAdd();
        DisplayPage.show();
        this.dispose();
    ...
    private void btnViewEmployeeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewEmployeeActionPerformed
        ManagerViewEmp DisplayPage = new ManagerViewEmp();
        DisplayPage.show();
        this.dispose();
    ...
    private void btnSearchEmployeeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchEmployeeActionPerformed
        ManagerSearchEmp DisplayPage=new ManagerSearchEmp();
        DisplayPage.show();
        this.dispose();
    ...
    private void btnDesignationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDesignationActionPerformed
        ManagerDesignation DisplayPage=new ManagerDesignation();
        DisplayPage.show();
        this.dispose();
    ...
    private void btnAddAssistantActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddAssistantActionPerformed
        ManagerUserAdd DisplayPage=new ManagerUserAdd();
        DisplayPage.show();
        this.dispose();
